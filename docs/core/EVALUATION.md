...
## Primary Metric: Reasoning Cost (Token Count per Task)

The primary metric is the **total token count** required to achieve a given outcome, used as the operational measure of reasoning cost:
